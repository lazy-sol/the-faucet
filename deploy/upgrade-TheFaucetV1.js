...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// TheFaucet ERC1967Proxy
	{
		...
		const proxy_deployment = await deployments.get("TheFaucet_Proxy");
		...
		if(implementation_address !== web3.utils.toChecksumAddress(v1_deployment.address)) {
			...
			console.log("TheFaucet_Proxy.upgradeTo(%o): %o", v1_deployment.address, receipt.transactionHash);
		}
	}
};
